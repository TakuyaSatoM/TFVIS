         ...
         boolean isLoop=false;
          ...
          if(num<=0){
           TProbe.Input_Route(TP_INSTANCEID,TP_METHODID,TP_METHODEXE,1  );
            ...
            for(int i=1;i<num;i++,TProbe.Input_Update(TP_INSTANCEID,TP_METHODID,TP_METHODEXE,5, "i",i,"i",false)){
             isLoop=true;
                         ...
                         boolean isLoop=false;
                          ...
                          if(num<=0){
                           TProbe.Input_Route(TP_INSTANCEID,TP_METHODID,TP_METHODEXE,1  );
                            ...
                            int sum=0;
                             TProbe.Input_Update(TP_INSTANCEID,TP_METHODID,TP_METHODEXE,4, "sum",sum,"",false);
                             TProbe.Input_Loop(TP_INSTANCEID,TP_METHODID,TP_METHODEXE,5);
                             boolean tvisLoopInit2=false;
                             TProbe.Input_LifeLimit(TP_INSTANCEID,TP_METHODID,TP_METHODEXE,5,"i");
                            for(int i=0;i<num;i++,TProbe.Input_Update(TP_INSTANCEID,TP_METHODID,TP_METHODEXE,5, "i",i,"i",false)){
                             isLoop=true;
                             if(tvisLoopInit2==false){tvisLoopInit2=true;TProbe.Input_Update(TP_INSTANCEID,TP_METHODID,TP_METHODEXE,5,"i",i,"",false);}
                              sum+=values[i];
                               TProbe.Input_Update(TP_INSTANCEID,TP_METHODID,TP_METHODEXE,6, "sum",sum,"sum,values["+i+"],i",false);
                              ...
                              int ave=sum/num;
                               TProbe.Input_Update(TP_INSTANCEID,TP_METHODID,TP_METHODEXE,8, "ave",ave,"sum,num",false);
