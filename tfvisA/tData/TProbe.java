...
public class TProbe {
	...
	//更新-int配列
	static public void Input_Update(int insID,int methodid,int methodexe,int line,String name,int[] array, boolean inputState)
	{
		 try
		 {
		  	  PrintWriter pw = new PrintWriter( new FileWriter(m_MethodFile, true) );    
	...
	//更新-String配列
	static public void Input_Update(int insID,int methodid,int methodexe,int line,String name,String[] array, boolean inputState)
	{
		 try
		 {
		  	  PrintWriter pw = new PrintWriter( new FileWriter(m_MethodFile, true) );    
	...
	//更新-double配列
	static public void Input_Update(int insID,int methodid,int methodexe,int line,String name,double[] array,boolean inputState)
	{
		 try
		 {
		  	  PrintWriter pw = new PrintWriter( new FileWriter(m_MethodFile, true) );    
	...
	//更新-int単体
	static public void Input_Update(int insID,int methodid,int methodexe,int line,String name,int var,String infs, boolean inputState)
	{
		 try
		 {
		  	  PrintWriter pw = new PrintWriter( new FileWriter(m_MethodFile, true) );    
		      pw.println(UPDATE_INT+DELIM+insID+DELIM+methodid+DELIM+methodexe+DELIM+line+DELIM+name+","+var+","+infs+","+DELIM+inputState+DELIM);
		      pw.close();	  	
		 }catch(IOException e){System.out.println(e);}   
	}	
	//更新-String単体
	static public void Input_Update(int insID,int methodid,int methodexe,int line,String name,String var,String infs, boolean inputState)
	{
		 try
		 {
		  	  PrintWriter pw = new PrintWriter( new FileWriter(m_MethodFile, true) );    
		      pw.println(UPDATE_STRING+DELIM+insID+DELIM+methodid+DELIM+methodexe+DELIM+line+DELIM+name+","+var+","+infs+","+DELIM+inputState+DELIM);
		      pw.close();	  	
		 }catch(IOException e){System.out.println(e);}   
	}	
	//更新-double単体
	static public void Input_Update(int insID,int methodid,int methodexe,int line,String name,double var,String infs, boolean inputState)
	{
		 try
		 {
		  	  PrintWriter pw = new PrintWriter( new FileWriter(m_MethodFile, true) );    
		      pw.println(UPDATE_DOUBLE+DELIM+insID+DELIM+methodid+DELIM+methodexe+DELIM+line+DELIM+name+","+var+","+infs+","+DELIM+inputState+DELIM);
		      pw.close();	  	
		 }catch(IOException e){System.out.println(e);}   
	}		
	...
	static public void Input_Object(int insID,int methodid,int methodexe,int line){
		try
		{
			PrintWriter pw = new PrintWriter( new FileWriter(m_MethodFile, true) );    
		    pw.println(INSTANCE+DELIM+insID+DELIM+methodid+DELIM+methodexe+DELIM+line+DELIM);
		    pw.close();
		}catch(IOException e){System.out.println(e);}
	}
}