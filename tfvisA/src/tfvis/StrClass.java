...
public class StrClass implements tfvisConstants{
	...
	public boolean doesHasMainMethod(){return m_HasMainMethod;}
	public void setMyID(int id){m_ID=id;}
	public int getHasMethodNum(){return m_Methods.size();}
	...
	public boolean hasMethod(String name){
		...
		for(Method index: m_Methods){
			if(index.getShortName().equals(name)){return true;}
		}
		return false;
	}
