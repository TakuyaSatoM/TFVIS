...
public class Program implements tfvisConstants {
	...
	public int trans_AvisIDtoTFVISID(int id, String state, boolean array) {
		...
		int arrayOffset = 0;
		if (array) {
			arrayOffset = ArrayMode;
		}

		if (id == Int) {
			return Ev_IntUpdate + arrayOffset;
		}
		if (id == Double) {
			return Ev_DoubleUpdate + arrayOffset;
		}
